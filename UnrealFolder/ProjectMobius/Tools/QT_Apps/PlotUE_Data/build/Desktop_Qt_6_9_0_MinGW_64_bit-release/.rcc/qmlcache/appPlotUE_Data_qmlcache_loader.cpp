...
namespace _qt_qml_PlotUE_Data_AppWindow_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appPlotUE_Data)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appPlotUE_Data))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appPlotUE_Data)() {
    return 1;
}
