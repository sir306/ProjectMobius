...
public class Visualization : ModuleRules
{
    public Visualization(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            ...
            string librariesPath = System.IO.Path.Combine(opencvProjectDir,"Source/ThirdParty/OpenCV/lib", platformString);
            PublicAdditionalLibraries.Add(System.IO.Path.Combine(librariesPath, "opencv_world455.lib"));
            PublicAdditionalLibraries.Add(System.IO.Path.Combine(librariesPath, "opencv_world455d.lib"));
            string binariesPath = System.IO.Path.Combine(opencvProjectDir,"Binaries/ThirdParty", platformString);
            string dllPath = System.IO.Path.Combine(binariesPath, "opencv_world455.dll");
